...
class MM0TestFileWriter(path: String, val shouldBeWeird:Boolean) : TestWriter, Closeable {
    ...
    override fun term(id: String, type: String, vararg binders: String, mm0Declaration: String) = if (mm0Declaration != "") fW.write(mm0Declaration) else this w TERM s id s binders.map{ it.toBinder()}.mm0() s ":" s type.toType().mm0() s ";" sr "\n"
    ...
    override fun def(id: String, type: String, tree: String, vararg binders: String, moreDummies: String, mm0Declaration: String) :Unit =if (mm0Declaration!="") write(mm0Declaration) else this s DEFINITION s id s binders.map{ it.toBinder()}.mm0() s ":" s type.toType().mm0() s "=" s "$" s tree s "$" s ";" sr "\n"
